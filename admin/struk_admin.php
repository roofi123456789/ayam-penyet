...
<div class="wrap">
    <div class="struk" id="strukEl">
        ...
        <div class="sb">
            ...
            <div class="srow"><span>Pemesan</span><span style="color:#2563EB;font-weight:800">👤 <?= htmlspecialchars($pesanan['nama_pelanggan']) ?></span></div>
            <?php endif; ?>
            <div class="srow"><span>Kasir</span><span><?= htmlspecialchars($_SESSION['admin_nama'] ?? 'Kasir') ?></span></div>
            <hr class="sdiv">
